...
namespace StartKryptograph
{
    class main
    {
        static void Main(string[] args)
        {
            ...
            var Buchstabe = new Dictionary<string, int>() { { "A", 0 }, { "AE", 0 }, { "B", 3 }, { "C", 1 }, { "D", 9 }, { "E", 0 }, { "F", 1 }, { "G", 2 }, { "H", 1 }, { "I", 15 }, { "J", 1 }, { "K", 2 }, { "L", 0 }, { "M", 5 }, { "N", 5 }, { "O", 0 }, { "OE", 0 }, { "P", 4 }, { "Q", 6 }, { "R", 0 }, { "SZ", 0 }, { "S", 0 }, { "T", 1 }, { "U", 9 }, { "UE", 0 }, { "V", 0 }, { "W", 0 }, { "X", 6 }, { "Y", 1 }, { "Z", 1 } };
